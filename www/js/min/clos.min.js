...
oa(u.length);S(u[z],!0);u.splice(z,1);v--}while(0<v);0===u.length?V(w):t.reset(!0)};y.H.addListener(this,()=>{r();this.g(C[L])});x.H.addListener(this,()=>{r();this.g(C[L])});let C=[new xb(10,5,5,0),new xb(15,7,8,0),new xb(50,10,10,1),new xb(70,13,14,2),new xb(100,16,20,3)],L=0,B=(v,z,K=1)=>{let D=z.s*(K+1)+1,J=z.v*(K+1)+1,X=new Xa(D,J,{frames:[],V:!1,qa:!0}),O=new ib(D,J);z.i.forEach((Y,sa)=>{Y.forEach((Kb,Lb)=>{Kb.ka.forEach((ca,ma)=>{if(ca){ca=f.l.W.P[ma].I;let bb=(K+1)*sa+(1+K/2),Mb=(K+1)*Lb+(1+
K/2),ta=bb-((K+1)*sa+1);for(let ua=-ta-1;ua<ta+1;ua++){let cb=bb+ua*(1-Math.abs(ca.x))+ca.x*(ta+Math.abs(Math.min(ca.x,0))),db=Mb+ua*(1-Math.abs(ca.y))+ca.y*(ta+Math.abs(Math.min(ca.y,0)));ma=X.i[cb][db];ma.V=!0;0===ma.frames.length&&(ma.frames=v,O.i[cb][db].filled=!0)}}})})});return{Nb:X,T:O}},r=()=>{t.reset(!1);u.length=0;Ea(this.a,a.b.L);ra(g,l);var v=this.a,z=l;v.ja.splice(G(v.ja,z),1);v.C.removeChild(z);Za(a.b.L,l);l=null;va(n,q);Ma(this.a,q);Fa(a.b.L,q);q.length=0;va(m,A);Ma(this.a,A);Fa(a.b.L,
A);A.length=0;ra(p,h);this.removeChild(h);h=null;this.removeChild(x);this.removeChild(y)};this.g=(v=C[L])=>{this.c.b.stop();var z=sb(f,v.size,v.size,v.Hb);z=B(["w0","w1","w2","w3"],z,3);Ga(this.a,z.Nb,a.b.L);Ja(this.a);this.a.a.forEach(O=>{O.forEach(Y=>{Y.visible&&(S(Y,!1),u.push(Y))})});H=Math.floor(.1*u.length);t.reset(!0);z=z.T;let K=[];z.forEach((O,Y,sa)=>{O.filled||K.push(new F(Y,sa))});var D=N(K);l=Q(g,{c:a,x:D.x*a.f,y:D.y*a.f,T:z});l.Wa.addListener(this,O=>{h.Ib(O);S(O,!1);O.active=!1;q.some(Y=>
Y.visible)||(L<C.length-1?L++:L=0,this.o(x),x.a(new F(a.b.h.position.x+a.b.h.width,a.b.h.position.y+(a.b.h.height-x.height)/2),new F(a.b.h.position.x+(a.b.h.width-x.width)/2,a.b.h.position.y+(a.b.h.height-x.height)/2),new F(a.b.h.position.x-x.width,a.b.h.position.y+(a.b.h.height-x.height)/2)),x.start(),l.Rb())});l.Va.addListener(this,()=>{this.o(y);y.a(new F(a.b.h.position.x+a.b.h.width,a.b.h.position.y+(a.b.h.height-y.height)/2),new F(a.b.h.position.x+(a.b.h.width-y.width)/2,a.b.h.position.y+(a.b.h.height-
y.height)/2),new F(a.b.h.position.x-y.width,a.b.h.position.y+(a.b.h.height-y.height)/2));y.start()});Ia(a.b.L,l);for(D=0;D<v.Jb;D++){var J=Q(m,{c:a,x:0,y:0,ib:K,T:z});A.push(J);Ia(a.b.L,J);La(this.a,J)}D=[...K];for(J=0;J<v.Pb;J++){let O=oa(D.length);var X=D[O];X=Q(n,{c:a,rb:X.x,sb:X.y});q.push(X);D.splice(O,1);Ia(a.b.L,X);La(this.a,X)}h=Q(p,{c:a,x:0,y:0,T:z,Ob:q,mb:l});this.o(h);La(this.a,l);this.c.b.start()}}}
